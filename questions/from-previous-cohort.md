...
1. **Unify all instances/references of “USER”, “PROVIDER”, “SERVICE PROVIDER“, “EMPLOYEE”, “CASE WORKER(?)” to one reference: \__\__\__\__\__**
2.

**Can you clearly define (possibly with examples) the difference and relationship between programs, categories, service types and employee/providers? Can we get an example of a service_type that would be in different and exclusive programs and/or categories?**\
****
...
1. **How to square this with PDL?**
   ...
   2. **https://lambda-students.slack.com/archives/C02AFKQBD2L/p1629179701339900?thread_ts=1629157829.338900\&cid=C02AFKQBD2L**
